...
const fetchItems = async()=>{
    ...
    const inputVendorList: NodeListOf< HTMLInputElement> = document.querySelectorAll(".input_vendor_li");
...
// click Accept Button 
     const btnAccept:HTMLInputElement | null = document.querySelector(".btn_accept")
...
btnShowHideVendors.addEventListener("click", function(){
    ...
    const vendorsList:HTMLElement | null = document.querySelector(".vendors_list")
